...
> [Amendment v1.1](PHASE_4_ARCHITECTURE_AMENDMENT_V1_1.md).** v1.0 received a
> **C — RETURN FOR REDESIGN** verdict on adversarial review; v1.1 corrects it
> and is the **current design of record**, as recorded in
> [PHASE_4_ARB_DETERMINATION_2026-07-21.md](PHASE_4_ARB_DETERMINATION_2026-07-21.md)
> ("Related documents": *"Superseded by v1.1; retained"*).
>
> **Do not implement from this document.** It is retained as the historical
> record of what was designed before the redesign. Everything below this
> banner is unedited.
>
> **Why this banner is not a history edit.**
> [RESEARCH_GOVERNANCE_STANDARD.md](RESEARCH_GOVERNANCE_STANDARD.md) §5
> requires a correction to be "cross-referenced *from* the file it
> supersedes" while simultaneously requiring that file be "retained,
> **unedited**" — two requirements that cannot both hold literally. This
> file had **never been committed** at the time the banner was added, so no
> committed historical record was altered and no history was rewritten. The
> §5 contradiction is logged as an open governance defect in
> [README.md](README.md) § "Known open governance defects", item 3.

**Status: superseded by v1.1 (see banner above). Not implemented; do not implement from this document.**
